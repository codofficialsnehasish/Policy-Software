                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Received</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-12">
                            <form class="custom-validation" action="{{ route('policy-payment.update', $policyPaymentMode->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
