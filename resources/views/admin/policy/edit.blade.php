                                                            ...
                                                            <div class="row">
                                                                {{-- <div class="row">
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{$policy->customer_id }}"   name="customer_id" id="customer_id" placeholder="Enter Customer ID" required>
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        {{--  --}}
                                                                        <input type="text" class="form-control"name="policy_no"  id="customer_id" placeholder="Enter Policy Number" value="{{ $policy->policy_no }}" required>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select class="form-select select2" id="customer_id" name="customer_id" required="">
                                                                            ...
                                                                            <option value="{{ $area->id }}" {{ $area->id == $policy->customer_id ? 'selected' : '' }}>{{ $area->name }} - {{ $area->customer_id }}</option>
                                                                        @endforeach
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <input type="number" class="form-control" name="sum_assured" id="name" placeholder="Enter Sum Assured" value="{{ $policy->sum_assured }}"  required>
                                                                        <div class="invalid-feedback">
                                                                            This field is required
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="input-group has-validation">
                                                                            ...
                                                                            <input type="number" value="{{$policy->premium_amount  }}" placeholder="Enter Premium Amount" class="form-control" name="premium_amount" id="premium_amount" aria-describedby="inputGroupPrepend" required>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="input-group" id="datepicker2">
                                                                            <input type="text" class="form-control" placeholder="dd M, yyyy" name="due_date" value="{{$policy->due_date }}"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select class="form-select select2" id="frequency" name="frequency" required="">
                                                                            <option selected="" disabled=""  value="">Choose...</option>
                                                                            @foreach ($FrequancyPolicy as $policy1)
                                                                            <option value="{{ $policy1->name }}" @if( $policy->frequency == $policy1->name) selected @endif>{{  $policy1->name }}</option>
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" name="policy_term" id="policy_term" placeholder="Enter Policy Term in Years" value="{{ $policy->policy_term}}"  required>
                                                                        <div class="invalid-feedback">
                                                                            This field is required
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" name="nominee_name" id="nominee_name" placeholder="Enter Nominee Name" value="{{ $policy->nominee_name }}"  required>
                                                                        <div class="invalid-feedback">
                                                                            This field is required
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" name="nominee_relationship" id="nominee_relationship" placeholder="Enter Nominee Relationship" value="{{ $policy->nominee_relationship }}"  required>
                                                                        <div class="invalid-feedback">
                                                                            This field is required
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="input-group has-validation">
                                                                            ...
                                                                            <input type="number" class="form-control" name="nominee_contact_number" id="phone" aria-describedby="inputGroupPrepend" placeholder="Enter Nominee Contact No." value="{{ $policy->nominee_contact_number }}"  required>
                                                                        </div>
                                                                        <div class="invalid-feedback">
                                                                            This field is required
                                                                        </div>
                                                                    ...
                                                                    <div class="mb-3 col-md-4 mt-2">
                                                                        ...
                                                                        <input class="form-check form-switch" type="checkbox" name="status" id="switch3"  @if ($policy->status==1) checked @endif value="{{  $policy->status }}" switch="bool"  >
                                                                        {{-- <input class="form-check form-switch" type="checkbox" name="status" id="switch3" @if ($policy->status==1) @endif value="1" switch="bool" checked value="{{ $policy->status }}"> --}}
