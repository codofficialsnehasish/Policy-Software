                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 mb-3">
                                                                    ...
                                                                    <div class="input-group has-validation">
                                                                        ...
                                                                        <input type="number" class="form-control" name="alternative_phone" id="alternative_phone" aria-describedby="inputGroupPrepend" required>
                                                                ...
                                                                <div class="col-md-3 mb-3">
                                                                    ...
                                                                    <select class="form-select select2" id="agent_id" name="agent_id" required="">
                                                                        ...
                                                                        <option value="{{ $area->id }}">{{ $area->name }} - {{ $area->agent_id }}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="col-md-4 mb-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" class="form-control" id="img" required placeholder="Enter Image" name="image" />
                                                                    </div>
                                                                ...
                                                                <div class="col-md-4 mb-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" class="form-control" id="img2" required placeholder="Enter Image" name="image2" />
                                                                    </div>
                                                                    <span class="text-danger">
                                                                        @error('status')
                                                                            {{ $message }}
