                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('bank-policy-payment.index') }}">{{ $title }}</a></li>
                    ...
                    <div class="col-md-4">
                        <div class="float-end d-none d-md-block">
                            <div class="dropdown">
                                <a href="{{ route('bank-policy-payment.index') }}" class="btn btn-primary  dropdown-toggle"
                                    aria-expanded="false">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-12">
                            <form class="custom-validation" action="{{ route('bank-policy-payment.update',$item->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select class="form-select select2" id="customer_id" name="customer_id" required="" onchange="get_polices_by_customer(this.value)">
                                                            ...
                                                            @foreach ($customers as $policy)
                                                                <option value="{{ $policy->id }}" @if($item->customer_id == $policy->id) selected @endif>{{ $policy->name }}  - {{ $policy->customer_id }}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select class="form-select select2" id="policy_option" name="policy_no">
                                                            ...
                                                            <option value="{{ $p->policy_no }}" @if($item->policy_number == $p->policy_no) selected @endif>{{ $p->policy_no}}</option>
                                                            @endforeach
                                                        </select>
                                                        <span class="text-danger">
                                                            @error('policy_no')
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-select select2" id="payment_mode" required="" name="payment_mode">
                                                            ...
                                                            <option value="{{ $policy->id }}" {{ $item->payment_mode == $policy->id ? 'selected' : '' }}>{{ $policy->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group has-validation">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                name="amount" id="amount" placeholder="Enter Amount" value="{{ $item->amount }}"
                                                    ...
                                                    <div class="col-md-4" id="additional_input_container" style="display: none;">
                                                        ...
                                                        <input type="text" class="form-control" id="additional_input" name="refference_number" placeholder="Enter Reference Number" value="{{ $item->refference_number }}">
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-md-4">
                                                        ...
                                                        <div class="input-group" id="datepicker2">
                                                            <input type="text" class="form-control" placeholder="dd M, yyyy"
                                                                ...
                                                                data-date-autoclose="true" name="payment_date" autoselect="off" value="{{ \Illuminate\Support\Carbon::parse($item->payment_date)->format('d M, Y') }}">
                                                    ...
                                                    <div class="col-md-4 mb-3 p-10">
                                                        ...
                                                        <textarea class="form-control" id="remarks" name="remarks" rows="4" cols="" placeholder="Remarks">{{ $item->remarks }}</textarea>
                                                        <div class="invalid-feedback">
